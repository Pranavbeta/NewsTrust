...
export class TranslationService {
  ...
  async translateText(
    ...
    try {
      ...
      const errorMsg = lingvanexError instanceof Error ? lingvanexError.message : String(lingvanexError);
      console.warn('Lingvanex failed, trying DeepL:', errorMsg);
      ...
      try {
        ...
        const errorMsg = deeplError instanceof Error ? deeplError.message : String(deeplError);
        console.warn('DeepL also failed:', errorMsg);
