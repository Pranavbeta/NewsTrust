...
const NewsCard: React.FC<Props> = ({ article }) => {
  ...
  return (
    <article className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all">
      {/* Article Header */}
      <div className="p-6">
